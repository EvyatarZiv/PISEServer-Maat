...
from examples.ghost import gh0st_rat_no_switch_inference_maat
...
def main():
    ...
    query_runner = sym_execution.QueryRunner('examples/ghost/gh0st_like_no_switch', [Gh0stSendHook(), Gh0stRecvHook(),
                                                                           HasMsgHook()],
                                             [gh0st_rat_no_switch_inference_maat.Gh0stRecvHook(),
                                              gh0st_rat_no_switch_inference_maat.Gh0stSendHook(),
                                              hooks.ConnectHook(gh0st_rat_no_switch_inference_maat.CONNECT_OFFSET),
                                              hooks.SocketHook(gh0st_rat_no_switch_inference_maat.SOCKET_OFFSET)],
                                             gh0st_rat_no_switch_inference_maat.MAIN_OFFSET)
